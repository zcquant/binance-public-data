...
symbols = sorted(os.listdir("/opt/binance_public_data_zip/data/futures/um/daily/aggTrades/"))

l = []

for symbol in symbols:
    files = sorted(os.listdir(f"/opt/binance_public_data_zip/data/futures/um/daily/aggTrades/{symbol}"))
    # if len(files) != 546:
